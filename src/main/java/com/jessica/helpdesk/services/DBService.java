...
public class DBService {
	...
	public void instanciaDB(){
        ...
        Tecnico tec1 = new Tecnico(null, "Jessica Cunha", "036.809.725-04", "jessica@mail.com", "123");
		tec1.addPerfil(Perfil.ADMIN);
		Tecnico tec2 = new Tecnico(null, "Willams Paixão", "046.796.805-55", "willams@mail.com", "123");
		...
		Tecnico tec6 = new Tecnico(null, "Richard Stallman", "903.347.070-56", "stallman@mail.com", "123");


		Cliente cli1 = new Cliente(null, "DANTE", "401.661.225-05", "dante@email.com", "123");
